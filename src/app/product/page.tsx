      ...
      <main className="px-8 md:px-16 pb-24 flex flex-col md:flex-row gap-8 md:gap-16 flex-1">
        ...
        <section className="flex-1 max-w-4xl">
          ...
          <h2 className="text-lg mb-6">
            ...
            <span className="font-bold text-black">Tambah Produk</span>
          </h2>
          ...
          <div className="bg-[#f8f8f8] rounded-md p-8 md:p-12">
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                <label className="w-32 text-sm font-medium">Nama Produk</label>
                <span className="text-sm font-medium">:</span>
                <input 
                  type="text" 
                  className="flex-1 max-w-[300px] bg-transparent border-b-2 border-dashed border-gray-400 focus:border-black outline-none text-sm pb-1"
                />
              </div>

              {/* Row: Kategori */}
              <div className="flex items-center gap-4">
                <label className="w-32 text-sm font-medium">Kategori</label>
                <span className="text-sm font-medium">:</span>
                <button className="bg-[#e5e5e5] hover:bg-gray-300 transition-colors text-black text-xs font-medium py-2 px-4 rounded-md flex items-center gap-3">
                  Pilih Kategori
                  <FontAwesomeIcon icon={faChevronDown} className="w-3 h-3" />
                </button>
              </div>
              ...
              {/* Row: Harga */}
              <div className="flex items-center gap-4">
                <label className="w-32 text-sm font-medium">Harga</label>
                <span className="text-sm font-medium">:</span>
                <input 
                  type="text" 
                  className="flex-1 max-w-[300px] bg-transparent border-b-2 border-dashed border-gray-400 focus:border-black outline-none text-sm pb-1"
              ...
              {/* Row: Stok */}
              <div className="flex items-center gap-4">
                <label className="w-32 text-sm font-medium">Stok</label>
                <span className="text-sm font-medium">:</span>
                <input 
                  type="text" 
                  className="flex-1 max-w-[300px] bg-transparent border-b-2 border-dashed border-gray-400 focus:border-black outline-none text-sm pb-1"
              ...
              {/* Row: Upload Gambar */}
              <div className="flex items-center gap-4">
                <label className="w-32 text-sm font-medium">Upload Gambar</label>
                <span className="text-sm font-medium">:</span>
                <button className="bg-[#e5e5e5] hover:bg-gray-300 transition-colors text-black text-xs font-medium py-2 px-6 rounded-md">
                  Pilih Gambar
                </button>
              </div>
              ...
              <div className="flex items-start gap-4 pt-1">
                <label className="w-32 text-sm font-medium mt-1">Deskripsi</label>
                <span className="text-sm font-medium mt-1">:</span>
                <textarea 
                  rows={1}
                  className="flex-1 max-w-[300px] bg-transparent border-b-2 border-dashed border-gray-400 focus:border-black outline-none text-sm resize-none"
                />
              </div>
            </div>
          </div>
