      ...
      <main className="px-8 md:px-16 pb-24 flex flex-col md:flex-row gap-8 md:gap-16 flex-1">
        ...
        <section className="flex-1 max-w-4xl">
          ...
          <h2 className="text-lg mb-6">
            ...
            <span className="font-bold text-black">Edit Produk</span>
          </h2>
          ...
          <div className="bg-[#f8f8f8] rounded-md p-8 md:p-12">
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm font-medium">:</span>
                <button className="bg-[#e5e5e5] hover:bg-gray-300 transition-colors text-black text-sm py-2 px-4 rounded-md flex items-center gap-6">
                  Keyboard
                  <FontAwesomeIcon icon={faChevronDown} className="w-3 h-3" />
                </button>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-sm text-gray-700">Keyboard.jpg</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 pt-1">
                ...
                <textarea 
                  rows={2}
                  defaultValue="Keyboard gaming RGB dengan lampu LED"
